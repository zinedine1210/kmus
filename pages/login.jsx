  ...
  return (
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="flex justify-center h-screen">
            <div class="hidden bg-cover lg:block lg:w-2/3 bg-slate-800" id="login">
                <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                    <div>
						<h1 className="text-white text-6xl uppercase font-semibold">Login</h1>
                        <h3 class="text-4xl font-bold text-white">Koperasi Jasa Mitra Usaha Sentosa</h3>
                        
                        <p class="max-w-xl mt-3 text-xl text-gray-300 tracking-wider">Belum membuat akun? <Link href={"/"}><span className="inline-block font-semibold cursor-pointer hover:text-blue-400">Buat akun</span></Link></p>
            ...
            <div class="flex items-center w-full max-w-md mx-auto lg:w-2/6">
                <div class="p-6 sm:p-8 lg:p-10 border space-y-8 w-full">
					...
					<form class="mt-8 space-y-6" onSubmit={(e) => handlerSubmit(e)}>
						<div>
							<label for="email" class="text-sm font-medium text-gray-900 block mb-2 dark:text-white">Username</label>
