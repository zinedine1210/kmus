  ...
  return (
    <>
        ...
        <nav className="flex items-center justify-between bg-white fixed top-0 px-3 lg:px-10 py-2 border w-full z-10">
            <div className="flex items-center">
                ...
                <div className="ml-2">
                    ...
                    <p className="text-gray-600 font-light text-xs lg:text-sm">Dashboard</p>
                </div>
        ...
        <section className="flex">
            ...
            <div className="pt-24 px-2 2xl:px-5 bg-slate-100 w-full h-screen overflow-y-scroll">
                <div className="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-1 lg:gap-3">
                    ...
                    <div className="bg-white shadow-md w-full p-5">
                        ...
                        <p className="text-sm lg:text-xl mt-0 lg:mt-2 font-light text-gray-500">Simpanan Wajib</p>
                    </div>

                    {/* Simpanan Pokok */}
                    <div className="bg-white shadow-md w-full p-5">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-700">Rp. 200.000,-</h1>
                        <p className="text-sm lg:text-xl mt-0 lg:mt-2 font-light text-gray-500">Simpanan Pokok</p>
                    </div>

                    {/* Simpanan Sukarela */}
                    <div className="bg-white shadow-md w-full p-5">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-700">Rp. 0,-</h1>
                        <p className="text-sm lg:text-xl mt-0 lg:mt-2 font-light text-gray-500">Simpanan Sukarela</p>
                    </div>

                    {/* Total Simpanan */}
                    <div className="bg-white shadow-md w-full p-5">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-700">Rp. 250.000,-</h1>
                        <p className="text-sm lg:text-xl mt-0 lg:mt-2 font-light text-gray-500">Total Simpanan</p>
                    </div>

                    {/* Pinjaman */}
                    <div className="bg-white shadow-md w-full p-5">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-700">Rp. 0,-</h1>
                        <p className="text-sm lg:text-xl mt-0 lg:mt-2 font-light text-gray-500">Pinjaman</p>
                    </div>
                </div>
            </div>
        </section>
