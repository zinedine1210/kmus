...
export default function simpanan() {
  ...
  return (
    <Layout title={tab} desc={`Halaman history ${tab}`} nav={tab}>
        <div className="bg-white p-5 dark:text-gray-100 dark:bg-gray-900">
            <h2 className="mb-3 text-2xl font-semibold leading-tight">{tab}</h2>
